...
cobby@cobby-VirtualBox:~/alx-system_engineering-devops/0x15-api$ python3 0-gather_data_from_an_API.py 4
...
cobby@cobby-VirtualBox:~/alx-system_engineering-devops/0x15-api$ python3 0-gather_data_from_an_API.py 4 | tr " " "S" | tr "\t" "T"
...
cobby@cobby-VirtualBox:~/alx-system_engineering-devops/0x15-api$
```
...
```sh
cobby@cobby-VirtualBox:~/alx-system_engineering-devops/0x15-api$ python3 1-export_to_CSV.py 2
cobby@cobby-VirtualBox:~/alx-system_engineering-devops/0x15-api$ cat 2.csv
